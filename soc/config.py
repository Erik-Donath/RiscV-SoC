...
class SoCConfig:
    ...
    def __post_init__(self):
        ...
        if self.firmware_target == FirmwareTarget.LINUX:
            # Linux requires specific CPU variant
            self.cpu_variant = "linux"
            # No integrated ROM for Linux (use external boot)
